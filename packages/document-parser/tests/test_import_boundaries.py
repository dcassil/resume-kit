"""Import-boundary enforcement for packages/document-parser.

Scans every .py source file under resume_kit_document_parser and asserts that
...
def test_no_forbidden_imports() -> None:
    ...
    assert not violations, (
        "Import boundary violations detected in packages/document-parser:\n"
